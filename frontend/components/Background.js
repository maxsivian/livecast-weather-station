...
const Background = () => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width='100%' className={styles.container}>
            <defs>
                <linearGradient id='a' gradientUnits='userSpaceOnUse' x1='0' x2='0' y1='0' y2='100%'
                    gradientTransform='rotate(133,960,472)'>
                    <stop offset='0' stopColor='var(--color6)' />
                    <stop offset='1' stopColor='var(--color6)' />
                </linearGradient>
                <pattern patternUnits='userSpaceOnUse' id='b' width='540' height='450' x='0' y='0'
